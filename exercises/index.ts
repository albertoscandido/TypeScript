...
console.log(`- Losango de lados 32cm e 18cm: ${Ex.getLosangoArea(32, 18)}cm²`);
console.log(`- Losango de lados 200cm e 50cm: ${Ex.getLosangoArea(200, 50)}cm²`);
console.log(`- Losango de lados 75cm e 25cm: ${Ex.getLosangoArea(75, 25)}cm²`);

console.log(`- Trapézio de bases 100cm e 70cm e altura 50cm: ${Ex.getTrapezeArea(100, 70, 50)}cm²`);
console.log(`- Trapézio de bases 75cm e 50cm e altura 35cm: ${Ex.getTrapezeArea(75, 50, 35)}cm²`);
console.log(`- Trapézio de bases 150cm e 120cm e altura 80cm: ${Ex.getTrapezeArea(180, 120, 50)}cm²`);

console.log(`- Cículo de raio 25cm: ${Ex.getCircleArea(25)}cm²`);
console.log(`- Cículo de raio 100cm: ${Ex.getCircleArea(100)}cm²`);
console.log(`- Cículo de raio 12,5cm: ${Ex.getCircleArea(12.5)}cm²`);
